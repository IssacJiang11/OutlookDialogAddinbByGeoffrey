(function () {
  ...
  Office.initialize = function (reason) {
    ...
    function btnRunClick() {
        ...
        //Office.context.ui.displayDialogAsync(window.location.origin + "OutlookDialogAddinWeb/ResultPage/success.html",
            //{ height: 50, width: 50, displayInIframe: true });

        Office.context.ui.displayDialogAsync('https://localhost/OutlookDialogAddinWeb/ResultPage/success.html',
